...
export class hello1621774155000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "submission" ("ethAddress" character varying NOT NULL, "vanityId" integer, "status" "submission_status_enum" NOT NULL DEFAULT 'VOUCHING', "currentlyRegistered" boolean NOT NULL DEFAULT false, "networkSubmissionAt" TIMESTAMP, "networkCreationAt" TIMESTAMP NOT NULL, "displayName" character varying NOT NULL, "firstName" character varying, "lastName" character varying, "bio" character varying, "photoUri" character varying, "videoUri" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_31b9f4d45368c2c147e85ba9dbc" PRIMARY KEY ("ethAddress"))`);
        await queryRunner.query(`CREATE TABLE "request" ("id" character varying NOT NULL, "resolved" boolean NOT NULL DEFAULT false, "disputed" boolean NOT NULL DEFAULT false, "isRegistration" boolean NOT NULL, "networkCreationAt" TIMESTAMP NOT NULL, "networkLastChangeAt" TIMESTAMP NOT NULL, "requesterEthAddress" character varying NOT NULL, "requesterLost" boolean NOT NULL DEFAULT false, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "submissionEthAddress" character varying NOT NULL, CONSTRAINT "PK_167d324701e6867f189aed52e18" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "evidence" ("id" character varying NOT NULL, "senderEthAddress" character varying NOT NULL, "uri" character varying NOT NULL, "isJson" boolean, "isRegistration" boolean, "cache" json, "networkCreationAt" TIMESTAMP NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "submissionEthAddress" character varying NOT NULL, "requestId" character varying NOT NULL, CONSTRAINT "PK_b864cb5d49854f89917fc0b44b9" PRIMARY KEY ("id"))`);
