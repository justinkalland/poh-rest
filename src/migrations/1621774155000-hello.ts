...
export class hello1621774155000 implements MigrationInterface {
  ...
  public async up (queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query('CREATE TABLE "request" ("id" citext NOT NULL, "resolved" boolean NOT NULL DEFAULT false, "disputed" boolean NOT NULL DEFAULT false, "isRegistration" boolean NOT NULL, "networkCreationAt" TIMESTAMP NOT NULL, "networkLastChangeAt" TIMESTAMP NOT NULL, "requesterEthAddress" citext NOT NULL, "requesterLost" boolean NOT NULL DEFAULT false, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "submissionEthAddress" citext NOT NULL, CONSTRAINT "PK_167d324701e6867f189aed52e18" PRIMARY KEY ("id"))')
    await queryRunner.query('CREATE TABLE "evidence" ("id" citext NOT NULL, "senderEthAddress" citext NOT NULL, "uri" character varying NOT NULL, "isJson" boolean, "isRegistration" boolean, "cache" json, "networkCreationAt" TIMESTAMP NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "submissionEthAddress" citext NOT NULL, "requestId" citext NOT NULL, CONSTRAINT "PK_b864cb5d49854f89917fc0b44b9" PRIMARY KEY ("id"))')
